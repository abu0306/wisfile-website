...
export const metadata: Metadata = {
  title:
    "AI File Renamer | Wisfile: AI-Powered File Renaming & Organizing Tool",
  description:
  ...
  alternates: {
    canonical: "https://www.wisfile.ai/features/ai-renamer",
  },
  openGraph: {
    title:
      "AI File Renamer | Wisfile: AI-Powered File Renaming & Organizing Tool",
    description:
      "100% Local AI File Renamer and Organizer — No Fees, No Data Leaks. " +
      "Automatically generates clear, consistent filenames based on content.",
    url: "https://www.wisfile.ai/features/ai-renamer",
    siteName: "WisFile",
    type: "website",
  },
  twitter: {
...
export default function AiRenamerLayout({
  children,
}: {
